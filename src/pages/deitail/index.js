...
class Detail extends Component {
  ...
  getCommentDom = process => {
    return (
      <div
        ...
        className={
          "comment " +
          (process.user.uid === "137e0c7a-08ab-4217-b7b0-2d987d1fd03f"
            ? "my-comment"
            : "")
        }
      >
        <Avatar src={process.user.avatar} key={process.user.uid} />
        <div
          className={
            "talk " +
            (process.user.uid === "137e0c7a-08ab-4217-b7b0-2d987d1fd03f"
  ...
  getExecutor = () => {
    if (this.props.task.executor) {
      return (
        <Avatar
          title={"执行者：" + this.props.task.executor.name}
          src={this.props.task.executor.avatar}
        />
      );
    }
  };
    ...
    return (
      <div className="detail">
        <div className="detail-content">
          <div className="detail-header">
            <div className="checkbox">
              <Checkbox
                ...
                key={this.props.task.is_finished}
                defaultChecked={this.props.task.is_finished === 1}
              />
            </div>
                ...
                <DatePicker
                  ...
                  defaultValue={
                    this.props.task.deadline
                      ? moment(new Date(this.props.task.deadline))
                      : null
                  }
                  showTime
          ...
          <div className="content">
            <div className="title">
              <TextArea
                autosize
                defaultValue={this.props.task.written_content}
                key={this.props.task.written_content}
              />
            </div>
            <div className="note">
              <TextArea
            ...
            <div className="file">
              <div className="sub-title">
                关联文件 ·{" "}
                {this.props.task.files ? this.props.task.files.length : 0}
              </div>
          ...
          <div className="process">
            <div className="avatar-list-wrap">
              <div className="sub-title">
                参与者 ·{" "}
                {this.props.task.participant
                  ? this.props.task.participant.length
                  : 0}
              </div>
        ...
        <div className="mention">
          <CommentMention
            project={
              this.props.project ? this.props.project : this.props.task.project
            }
          />
        </div>
      </div>
